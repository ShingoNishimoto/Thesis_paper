...
衛星内部でのコンポーネント間のつながりを表現するために「ポート」と「導管」%ここの説明を考える
という概念を定義している．
%論文ではもう少し詳細に説明する．
...
%リンクという言葉を急に出しているが，定義しているのはモデル化のところ
\subsection{コマンド評価指標}
...
%安全を確保しながら確実に切り分けを行えることが最重要と言いたい．
...
ノードDからノードAまでの経路(8,9)が正常である必要がある．%正常であるというより途切れていないという意味
