...
\begin{itemize} %ここの順番と以下の順番を一致させる
  ...
  \item 故障箇所の特定を行うために必要なコマンド及びテレメトリの探索アルゴリズム%これいるのか？説明する価値があるのか？
  \item コマンドの安全性及び，故障候補切り分け能力を示す指標
\end{itemize}
本手法を用いた不具合分析の流れを下図\ref{fig:fault_diagnosis_flow}に示す．
本研究の対象は色付けているところであり，%うむ
人間と対話的に故障箇所の特定を行う．これにより %うむ，人間による推論も使える．．
...
%不具合分析についての流れは上で概要を説明しているので，ここではどうやって確認するためのコマンドとテレメトリの
%組み合わせみたいなものを探しているのかについて説明する必要がある．
\subsection{探索アルゴリズム}
\vspace{-1zh}
フローチャート
...
\subsubsection{コマンドの故障候補切り分け能力}
 ...
 形成される経路が3つ存在する場合を考える．%3つでなくてもいい
...
の正常が確認できており，
1つのコマンドで残り1つのリンクにまで絞り込めている．%びみょいな
