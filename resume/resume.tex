...
また上に示すように，故障箇所によっては最終的な特定までできないものもあり，(冗長な通信ラインが存在しないもの)
実ミッションに適用することで，故障箇所特定のために必要な設計を行うための
フィードバックが可能であると考えている．\\
また，特定を行えなかった場合も，不具合分析過程において得られた情報より故障箇所の推論をすることが可能であり，
体系化された本手法の分析過程に従うことで故障箇所の推論に必要な情報を集めることができる．
